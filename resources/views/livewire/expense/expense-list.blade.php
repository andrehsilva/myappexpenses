<div class="max-w-7xl mx-auto py-15 px-4">
    ...
    <div class="w-full mx-auto text-right mb-4">
        <a href="{{route('expenses.create')}}" class="flex-shrink-0 bg-green-700 hover:bg-green-900 border-green-700 hover:border-green-900 text-sm border-4 text-white py-3 px-6 rounded">Criar Registro</a>
    </div>
        ...
        <tbody>
            ...
            <tr class="bg-white">
                ...
                <td class="px-4 py-2 border">
                    <span class="{{$exp->type == 1 ? 'text-green-600' : 'text-red-400' }} " > R$ {{number_format($exp->amount, 2, ',','.')}}</span></td>
